...
Write-Host "Setting up Portfolio Website..." -ForegroundColor Green
...
Set-Content -Path "app\wordpress\page.tsx" -Value $wordpressContent
Write-Host "Created: app\wordpress\page.tsx" -ForegroundColor Green

Write-Host "`nSetup complete! Run 'npm install' then 'npm run dev'" -ForegroundColor Green
